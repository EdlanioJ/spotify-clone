...
export default function Cover({ artist }: Props) {
  ...
  return (
    <div className="w-full flex flex-col">
      <div className="w-full h-[35vh] border-none shadow-none max-h-[500px] min-h-[340px] relative px-6 pb-6 pt-4 text-white flex gap-6">
        <div
          className="absolute inset-0 bg-no-repeat lg:bg-center bg-cover bg-local"
